...
public class MainClass {
    public static void main(String[] args) {
        int[][] massForMatrix = convertToIntMass(readFromFile("StartMatrix2.txt").orElseGet(() -> new String[]{"something"}));
        ...
        System.out.println(matrix.convertToIncidenceMatrix().convertToListOfIncidentEdges().convertToListOfAdjacentVertices().graphTraversalInDepth(1));
    }
}
